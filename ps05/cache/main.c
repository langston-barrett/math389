...
const int64_t l1_guess = 4100000; // 512kb in bits
const int64_t l2_guess = 128000000; // 16mb in bits
const int64_t l3_guess = 512000000; // 64mb in bits
...
int main(void) {
  ...
  //int64_t l1_step_size = 8000;
  //int64_t length_times_L1 = l1_guess / (8 * l1_step_size);
  //int64_t *sizes = malloc(length_times_L1*sizeof(int64_t));
  //double *arr = find_cache_size(l1_step_size, l1_guess, 10);
